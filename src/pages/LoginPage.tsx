      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-[#141414] border border-[#2a2a2a] rounded-2xl p-8 space-y-4">
          ...
          {(mode === 'login' || mode === 'signup') && (
            <a href={`https://cademeusalario.auth.us-east-1.amazoncognito.com/oauth2/authorize?client_id=${import.meta.env.VITE_COGNITO_CLIENT_ID}&response_type=token&scope=openid+email+profile&redirect_uri=${encodeURIComponent(window.location.origin + '/')}&identity_provider=Google`}
